...
public class NvWhitelistService {
    ...
    public NvWhitelistService(Context context) {
        ...
        int identifier = mContext.getResources().getSystem().getIdentifier("tv_launcher_app_white_list", "xml", "android");
        if (identifier != 0)
            mWhiteListArray = parseXml(mContext.getResources().getXml(identifier));
    }
