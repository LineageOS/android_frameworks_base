...
public class NvAppProfileService {
    ...
    public boolean canForceHwUi(String appName) {
        ...
        if (mAppProfile.getApplicationProfile(packageName, NvAppProfileSettingId.FORCE_HW_UI) <= 0)
            return false;
    ...
    public List<String> getAppProfileForceQueryAppList() {
        String applicationProfileString = mAppProfile.getApplicationProfileString("com.nvidia.shield.force_query_app_list", NvAppProfileSettingId.FORCE_QUERY_PACKAGES);
    ...
    public List<String> getAppProfileAutoMediaScanPackages() {
        String applicationProfileString = mAppProfile.getApplicationProfileString("com.nvidia.shield.auto_media_scan_packages", NvAppProfileSettingId.AUTO_MEDIA_SCAN_PACKAGES);
        if (TextUtils.isEmpty(applicationProfileString)) {
            return null;
        }
        return Arrays.asList(applicationProfileString.split(";"));
    ...
    private void setGpuModeSetting(String packageName) {
        mAppProfile.getApplicationProfile(packageName, NvAppProfileSettingId.GPU_MODESET_ENABLE);
    }
