...
public class ComponentInfo extends PackageItemInfo {
    ...
    public CharSequence loadDescription(@NonNull PackageManager pm) {
        ...
        if (descriptionRes != 0) {
            try {
                CharSequence description = pm.getText(packageName, descriptionRes, applicationInfo);
                if (description != null && description.length() > MAX_SAFE_DESCRIPTION_LENGTH) {
                    return description.subSequence(0, MAX_SAFE_DESCRIPTION_LENGTH);
                }
                return description;
