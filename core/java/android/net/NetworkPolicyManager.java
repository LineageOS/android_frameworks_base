...
public class NetworkPolicyManager {
    ...
    /** Reject network usage on all networks (unconditionally) */
    public static final int POLICY_REJECT_ALL_ISOLATED = 0x40000;
    ...
    /** Reject traffic on all networks unconditionally. */
    public static final int RULE_REJECT_ALL_ISOLATED = 1 << 7;
