...
public class Camera {
    ...
    public static int getNumberOfCameras() {
        ...
        if (!packageBlacklist.isEmpty() || Arrays.asList(packageList.split(",")).contains(packageName)) {
                exposeAuxCamera = true;
        } else if (!packageList.isEmpty() || Arrays.asList(packageBlacklist.split(",")).contains(packageName)) {
