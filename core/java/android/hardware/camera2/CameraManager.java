    ...
    private static final class CameraManagerGlobal extends ICameraServiceListener.Stub
        ...
        public String[] getCameraIdList() {
            ...
            synchronized(mLock) {
                ...
                String packageList =
                    SystemProperties.get("vendor.camera.aux.packagelist", "");
                String packageBlacklist = SystemProperties.get(
                    "vendor.camera.aux.packageblacklist", "");
                if (!packageList.isEmpty() ||
                    Arrays.asList(packageBlacklist.split(","))
        ...
        private void onStatusChangedLocked(int status, String id) {
            ...
            String packageBlacklist =
                SystemProperties.get("vendor.camera.aux.packageblacklist", "");
            if (!packageList.isEmpty() || (Arrays.asList(packageBlacklist.split(",")).contains(packageName)) {
                exposeMonoCamera = false;
            } else if (!packageBlacklist.isEmpty() || (Arrays.asList(packageList.split(",")).contains(packageName)) {
