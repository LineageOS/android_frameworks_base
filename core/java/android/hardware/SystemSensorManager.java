...
public class SystemSensorManager extends SensorManager {
    ...
    // Config
    private boolean mDenyAccelBatch = false;
    ...
    public SystemSensorManager(Context context, Looper mainLooper) {
        ...
        mDenyAccelBatch = context.getResources().getBoolean(
            com.android.internal.R.bool.config_denyAccelBatch);
    ...
    protected boolean registerListenerImpl(SensorEventListener listener, Sensor sensor,
        ...
        if (mDenyAccelBatch && (sensor.getType() == Sensor.TYPE_ACCELEROMETER) && (maxBatchReportLatencyUs > 0)) {
            Log.e(TAG, "batch disabled for this sensor");
