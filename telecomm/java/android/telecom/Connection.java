...
public abstract class Connection extends Conferenceable {
     ...
     * @hide
     */
    public static final int PROPERTY_HELD_REMOTELY = 1 << 10;

    /**
     * Whether the dialing state is waiting for the busy remote side
     * @hide
     */
    public static final int PROPERTY_DIALING_IS_WAITING = 1 << 11;

    /**
     * Whether an additional call came in and was forwarded while the call was active
     * @hide
     */
    public static final int PROPERTY_ADDITIONAL_CALL_FORWARDED = 1 << 12;

    /**
     * Whether incoming calls are barred at the remote side
     * @hide
     */
    public static final int PROPERTY_REMOTE_INCOMING_CALLS_BARRED = 1 << 13;
