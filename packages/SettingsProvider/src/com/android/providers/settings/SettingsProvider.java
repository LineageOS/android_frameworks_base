        ...
        private final class UpgradeController {
            ...
            private int onUpgradeLocked(int userId, int oldVersion, int newVersion) {
                ...
                if (currentVersion == 144) {
                    ...
                    SettingsState secureSettings = getSettingsLocked(userId);
                    String defaultTvSetupSetting = (getContext().getResources().getString(
                            R.string.def_tv_user_setup_complete));
                    Setting currentUserSetupSetting = secureSettings.getSettingLocked(
                            Settings.Secure.USER_SETUP_COMPLETE);
                    if (defaultTvSetupSetting == false && currentUserSetupSetting == "1") {
                        secureSettings.insertSettingLocked(
