...
import dev.kdrag0n.monet.util.square
import dev.kdrag0n.monet.util.toDegrees
import dev.kdrag0n.monet.util.toRadians
import kotlin.math.*
...
data class Zcam(
    ...
    companion object {
        ...
        fun createZcamViewingConditions(whiteLuminance: Double) = ViewingConditions(
            F_s = ViewingConditions.SURROUND_AVERAGE,
            // sRGB
