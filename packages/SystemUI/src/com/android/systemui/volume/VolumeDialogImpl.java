...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void initDialog() {
        ...
        mDialogView.setLayoutDirection(mVolumePanelOnLeft ? LAYOUT_DIRECTION_LTR : LAYOUT_DIRECTION_RTL);
        ...
        if (mVolumePanelOnLeft) {
            ...
            setGravity(mDialog.findViewById(R.id.volume_dialog_top_container), Gravity.LEFT);
    ...
    private boolean shouldBeVisibleH(VolumeRow row, VolumeRow activeRow) {
        ...
        if (!mShowActiveStreamOnly) {
            ...
            if (row.stream == STREAM_RING) return true;
    ...
    private void updateRowsH(final VolumeRow activeRow) {
        ...
        for (final VolumeRow row : mRows) {
            ...
            if (shouldBeVisible && mRingerAndDrawerContainerBackground != null) {
                ...
                // from right to left.
                outmostVisibleRowIndex =
                        isOutmostIndexMax
                                ? Math.max(outmostVisibleRowIndex,
                                mDialogRowsView.indexOfChild(row.view))
                                : Math.min(outmostVisibleRowIndex,
                                        mDialogRowsView.indexOfChild(row.view));
