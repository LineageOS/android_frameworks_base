...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private final ValueAnimator mAnimateUpBackgroundToMatchDrawerInverted = ValueAnimator.ofFloat(0f, 1f);
    ...
    private void setupRingerDrawer() {
        ...
        mAnimateUpBackgroundToMatchDrawerInverted.addUpdateListener(valueAnimator -> {
            mRingerDrawerClosedAmount = (float) valueAnimator.getAnimatedValue();
            updateBackgroundForDrawerClosedAmount();
        });
    }
    ...
    private void showRingerDrawer() {
        ...
        if (mVolumePanelOnLeft && isLandscape()) {
            mAnimateUpBackgroundToMatchDrawerInverted.setDuration(ringerDrawerAnimationDuration);
            mAnimateUpBackgroundToMatchDrawerInverted.setInterpolator(Interpolators.FAST_OUT_SLOW_IN);
            mAnimateUpBackgroundToMatchDrawerInverted.start();
        } else {
    ...
    private void hideRingerDrawer() {
        ...
        if (mVolumePanelOnLeft && isLandscape()) {
            mAnimateUpBackgroundToMatchDrawerInverted.setDuration(DRAWER_ANIMATION_DURATION);
            mAnimateUpBackgroundToMatchDrawerInverted.setInterpolator(Interpolators.FAST_OUT_SLOW_IN_REVERSE);
            mAnimateUpBackgroundToMatchDrawerInverted.reverse();
        } else {
    ...
    private void updateBackgroundForDrawerClosedAmount() {
        ...
        if (!isLandscape()) {
            ...
            bounds.right = (int) ((mDialogCornerRadius / 2) + mRingerDrawerItemSize
                    + mRingerDrawerClosedAmount * getRingerDrawerOpenExtraSize());
        } else {
    ...
    private class RingerDrawerItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mRingerDrawerNewSelectionBg.animate()
                    ...
                    .setDuration(DRAWER_ANIMATION_DURATION_SHORT * 3)
                    .withEndAction(() -> {
                        mRingerDrawerNewSelectionBg.setAlpha(0f);
