    ...
    private void updateRowsH(final VolumeRow activeRow, boolean animate) {
        ...
        if (outmostVisibleRowIndex > -1 && outmostVisibleRowIndex < Short.MAX_VALUE) {
            ...
            if (animate) {
                ...
                // Add a solid background to the rightmost row temporary so that other rows animate
                // behind it
            ...
            for (final VolumeRow row : mRows) {
                ...
                String varInfo = "mExpanded: " + mExpanded + ", lastChildLocX: "
                        + lastVisibleChildLocation[0] + ", locX: " + locInWindow[0]
                        + ", transX: " + row.view.getTranslationX() + ", distance: " + distance;
                    ...
                    row.view.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    // Restore the elevation and background after all rows have
                                    // animated
                                    // TODO can this be done after all rows finished animating?
                                    // postDelayed doesn't play well with fast taps on the
