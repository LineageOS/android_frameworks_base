...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private void animateExpandedRowsChange(boolean expand) {
        ...
        ValueAnimator a = ValueAnimator.ofInt(startWidth, targetWidth);
        ...
        a.setInterpolator(expand ? new SystemUIInterpolators.LogDecelerateInterpolator()
                : new SystemUIInterpolators.LogAccelerateInterpolator());
        a.setDuration(UPDATE_ANIMATION_DURATION);
        a.start();
    }
