    ...
    private void updateRowsH(final VolumeRow activeRow, boolean animate) {
        ...
        if (rightmostVisibleRowIndex > -1 && rightmostVisibleRowIndex < Short.MAX_VALUE) {
            ...
            if (animate) {
                ...
                float elevation = lastVisibleChild.getElevation();
                // TODO restore this later and increase it instead of hardcoding 1
                lastVisibleChild.setElevation(1f);
            }
                    ...
                    row.view.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    // Restore the transparent background of the rightmost row
                                    lastVisibleChild.setBackgroundColor(Color.TRANSPARENT);
                                }
                            });
                } else {
