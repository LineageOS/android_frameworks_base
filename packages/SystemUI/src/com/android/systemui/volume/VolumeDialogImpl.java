...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    private boolean isMediaControllerConnected(MediaController mediaController) {
    ...
    public void initSettingsH() {
        if (mSettingsView != null) {
            mSettingsView.setVisibility(mDeviceProvisionedController.isCurrentUserSetup()
                                    && mActivityManager.getLockTaskModeState()
                                            == LOCK_TASK_MODE_NONE
                                    && isMediaControllerConnected(getActiveLocalMediaController())
        ...
        if (mSettingsIcon != null) {
            mSettingsIcon.setOnClickListener(v -> {
                ...
                String packageName = isMediaControllerConnected(mediaController)
