...
public class VolumeDialogImpl implements VolumeDialog,
    ...
    public void initSettingsH() {
        ...
        if (mExpandRows != null) {
            mExpandRows.setOnClickListener(v -> {
                if (mMusicHidden) Util.setVisOrGone(findRow(AudioManager.STREAM_MUSIC).view, !mExpanded);
    ...
    private boolean shouldBeVisibleH(VolumeRow row, VolumeRow activeRow) {
        ...
        if (row.stream == AudioSystem.STREAM_MUSIC && activeRow.stream != AudioSystem.STREAM_MUSIC) {
            mMusicHidden = true;
            return false;
        }
