...
public class BatteryMeterView extends LinearLayout implements
    ...
    private void updateShowPercent() {
        ...
        final boolean percentModeEstimate = mShowPercentMode == MODE_ESTIMATE;
        final boolean drawPercentInside = !percentModeEstimate && showBatteryPercent == 1;
        final boolean drawPercentOnly = percentModeEstimate || showBatteryPercent == 2;
