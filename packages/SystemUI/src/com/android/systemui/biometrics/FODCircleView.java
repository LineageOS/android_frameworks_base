...
public class FODCircleView extends ImageView implements OnTouchListener {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // onLayout is triggered after the dim amount set using updateViewLayout
        // takes effect
        // notify the HAL here so it doesn't boost brightness without the dim layer
        // in place
        if (mIsCircleShowing) {
            dispatchPress();
        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN && newIsInside) {
            ...
            // Finger up, stop receiving touch events
            return false;
        }

        // Finger moving, receive following touch events for this gesture
        return true;
    }
    ...
    public void hideCircle() {
        ...
        // notify the HAL here so it doesn't unboost brightness after
        // the dim layer has been removed
        dispatchRelease();
