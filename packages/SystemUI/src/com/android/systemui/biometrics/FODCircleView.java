...
public class FODCircleView extends ImageView implements TunerService.Tunable {
    ...
    public FODCircleView(Context context) {
        ...
        final float[] brightness = getFloatArray(res.obtainTypedArray(R.array.config_FODCircleBrightnessLevels));
        final float[] alpha = getFloatArray(res.obtainTypedArray(R.array.config_FODCircleAlphaLevels));
    ...
    public void onTuningChanged(String key, String newValue) {
        mCurrentBrightness = newValue != null ? Integer.parseInt(newValue) : mDefaultScreenBrightness;
        updateAlpha();
    }
