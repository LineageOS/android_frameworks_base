...
public class UdfpsController implements DozeReceiver, Dumpable {
    ...
    public UdfpsController(@NonNull Context context,
        ...
        initUdfpsFrameworkDimming(context);
    ...
    private void initUdfpsFrameworkDimming(Context context) {
    ...
    private int getBrightness() {
        ...
        final int brightnessMin =
                mContext.getResources().getInteger(R.integer.config_udfpsDimmingBrightnessMin);
        final int brightnessMax =
                mContext.getResources().getInteger(R.integer.config_udfpsDimmingBrightnessMax);
        if (brightnessMax > 0) {
