...
public class ThemeOverlayController extends SystemUI implements Dumpable {
    ...
    protected @Nullable FabricatedOverlay getOverlay(int color, int type) {
        ...
        FabricatedOverlay.Builder builder = new FabricatedOverlay.Builder(mContext.getPackageName(), type, "android");
        ...
        for (int i = 0; i < colors.size(); i++) {
            ...
            if (lightness == 0) {
                targetResource = "android:color/system_" + type + shade + "_10";
            } else if (lightness == 1) {
                targetResource = "android:color/system_" + type + shade + "_50";
            } else {
                targetResource = "android:color/system_" + type + shade + "_" + (lightness - 1) + "00";
            }
