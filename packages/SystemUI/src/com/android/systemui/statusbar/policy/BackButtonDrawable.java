...
public class BackButtonDrawable extends KeyButtonDrawable {
    private float mRotation;
    private Animator mCurrentAnimator;

    private static final int ANIMATION_DURATION = 200;

    public static BackButtonDrawable create(Drawable lightDrawable,
            @Nullable Drawable darkDrawable) {
        return (BackButtonDrawable) super.create(lightDrawable, darkDrawable);
    }
