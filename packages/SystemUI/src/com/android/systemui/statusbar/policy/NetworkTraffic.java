...
public class NetworkTraffic extends TextView {
    ...
    private long mTxBytesTotal;
    private long mRxBytesTotal;
    private long mTxBytesDelta;
    private long mRxBytesDelta;
    ...
    private Handler mTrafficHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MESSAGE_TYPE_PERIODIC_REFRESH
                ...
                mTxBytesDelta = TrafficStats.getTotalTxBytes() - mTxBytesTotal;
                mRxBytesDelta = TrafficStats.getTotalRxBytes() - mRxBytesTotal;
                mTxBytesTotal += mTxBytesDelta;
                mRxBytesTotal += mRxBytesDelta;
            }
            ...
            if (!enabled || shouldHide()) {
                ...
                if (shouldShowUpstream()) {
                    output.append(formatOutput(timeDelta, mTxBytesDelta));
                }
                ...
                if (shouldShowDownstream()) {
                    output.append(formatOutput(timeDelta, mRxBytesDelta));
                }
        ...
        private String formatOutput(long timeDelta, long bytes) {
            ...
            return mContext.getString(R.string.network_traffic_format, value, unit);
        }
        ...
        private boolean shouldHide() {
            ...
            long speedTxKB = (long) (mTxBytesDelta / (mTimeDelta / 1000f)) / 1024;
            long speedRxKB = (long) (mRxBytesDelta / (mTimeDelta / 1000f)) / 1024;
