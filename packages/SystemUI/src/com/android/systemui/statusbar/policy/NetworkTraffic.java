...
public class NetworkTraffic extends TextView {
    ...
    private Handler mTrafficHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            long newmtotalRxBytes = TrafficStats.getmtotalRxBytes();
            long newmtotalTxBytes = TrafficStats.getmtotalTxBytes();
            long rxData = newmtotalRxBytes - mtotalRxBytes;
            long txData = newmtotalTxBytes - mtotalTxBytes;
            ...
            if (shouldHide(rxData, txData, timeDelta)) {
                ...
                if (isSet(mState, MASK_UP + MASK_DOWN)) {
                    output += "\n";
                    textSize = mtxtSizeMulti;
                } else {
                    textSize = mtxtSizeSingle;
                }
            ...
            mtotalRxBytes = newmtotalRxBytes;
            mtotalTxBytes = newmtotalTxBytes;
            clearHandlerCallbacks();
    ...
    public NetworkTraffic(Context context, AttributeSet attrs, int defStyle) {
        ...
        mtxtSizeSingle = resources.getDimensionPixelSize(R.dimen.net_traffic_single_text_size);
        mtxtSizeMulti = resources.getDimensionPixelSize(R.dimen.net_traffic_multi_text_size);
    ...
    private void updateSettings() {
        ...
        if (isSet(mState, MASK_UP) || isSet(mState, MASK_DOWN)) {
            if (getConnectAvailable()) {
                if (mAttached) {
                    mtotalRxBytes = TrafficStats.getmtotalRxBytes();
                    mlastUpdateTime = SystemClock.elapsedRealtime();
