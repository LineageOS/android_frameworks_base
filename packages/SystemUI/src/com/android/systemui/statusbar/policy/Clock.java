...
public class Clock extends TextView implements DemoMode, Tunable, CommandQueue.Callbacks,
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            ...
            final int clockAutoHide = LineageSettings.System.getInt(
                    getContext().getContentResolver(),
                    LineageSettings.System.STATUS_BAR_CLOCK_AUTO_HIDE,
                    0);
            handleTaskStackListener(clockAutoHide == 1);
        }
    ...
    private void updateShowClock() {
        ...
        final boolean clockAutoHide = activityType == ACTIVITY_TYPE_HOME;
