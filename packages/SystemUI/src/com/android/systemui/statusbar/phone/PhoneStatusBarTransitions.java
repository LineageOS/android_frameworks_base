...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public PhoneStatusBarTransitions(PhoneStatusBarView statusBarView, View backgroundView) {
        ...
        mNetworkTraffic.setViewPosition(0);         /* centered display */
        mNetworkTrafficRight.setViewPosition(1);    /* right display */
        mNetworkTrafficLeft.setViewPosition(2);     /* left display */
