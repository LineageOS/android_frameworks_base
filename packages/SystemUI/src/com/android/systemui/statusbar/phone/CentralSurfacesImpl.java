...
import static lineageos.providers.LineageSettings.System.FORCE_SHOW_NAVBAR;
...
public class CentralSurfacesImpl implements CoreStartable, CentralSurfaces {
    ...
    public void start() {
            ...
            public void onChange(boolean selfChange) {
                if (mDisplayId == Display.DEFAULT_DISPLAY
                    ...
                    boolean forcedVisibility = mNeedsNavigationBar || LineageSettings.System.getInt(
                            mContext.getContentResolver(), FORCE_SHOW_NAVBAR, 0) != 0;
        ...
        mContext.getContentResolver().registerContentObserver(
                LineageSettings.System.getUriFor(FORCE_SHOW_NAVBAR), false, contentObserver);
