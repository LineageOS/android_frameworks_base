...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, OnColorsChangedListener,
    ...
    public ScrimController(ScrimView scrimBehind, ScrimView scrimInFront,
        ...
        mLockColors = getDarkGradientColor(WallpaperManager.FLAG_LOCK, true);
        mSystemColors = getDarkGradientColor(WallpaperManager.FLAG_SYSTEM, true);
    ...
    private GradientColors getDarkGradientColor(int flag, boolean ignoreVisibility) {
        GradientColors fromWallpaper = mColorExtractor.getColors(flag, ColorExtractor.TYPE_DARK,
                ignoreVisibility);
        int color = fromWallpaper.supportsDarkText()
                ? SCRIM_TRANSPARENT_COLOR
                : SCRIM_DEFAULT_COLOR;
