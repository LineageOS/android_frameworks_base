    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mOneFingerQuickSettingsIntercept = Settings.System.getIntForUser(
                    resolver, LineageSettings.System.STATUS_BAR_QUICK_QS_PULLDOWN, 1, UserHandle.USER_CURRENT) == 1;
            mDoubleTapToSleepEnabled = LineageSettings.System.getIntForUser(
                    resolver, LineageSettings.System.DOUBLE_TAP_SLEEP_GESTURE, 1, UserHandle.USER_CURRENT) == 1;
        }
    }
}
