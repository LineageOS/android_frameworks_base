    ...
    public ClockController(Context context, View statusBar) {
        ...
        ContentObserver contentObserver = new ContentObserver(null) {
            ...
            public void onChange(boolean selfChange, @Nullable Uri uri) {
                if (Settings.Secure.getUriFor(StatusBarIconController.ICON_HIDE_LIST).equals(uri)) {
                    mBlackListed = StatusBarIconController.getIconHideList(mContext,
                            Settings.Secure.getString(mContext.getContentResolver(),
                                    StatusBarIconController.ICON_HIDE_LIST)).contains("clock");
                } else if (LineageSettings.System.getUriFor(
                        LineageSettings.System.STATUS_BAR_CLOCK).equals(uri)) {
        ...
        mContext.getContentResolver().registerContentObserver(
                ...
                contentObserver);
        mContext.getContentResolver().registerContentObserver(
                LineageSettings.System.getUriFor(LineageSettings.System.STATUS_BAR_CLOCK), false,
                contentObserver);
    }
