...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (mMediaMetadata != null && (CMSettings.Secure.getIntForUser(mContext.getContentResolver(),
            CMSettings.Secure.LOCKSCREEN_MEDIA_METADATA, 1, UserHandle.USER_CURRENT) == 1)) {
