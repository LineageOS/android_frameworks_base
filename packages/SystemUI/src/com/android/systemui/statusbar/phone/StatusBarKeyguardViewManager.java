...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
     ...
     */
    protected void showBouncerOrKeyguard(boolean hideBouncerWhenShowing, final boolean isBackPressed) {
     ...
     */
    public void reset(boolean hideBouncerWhenShowing, final boolean isBackPressed) {
        if (mShowing) {
            if (mOccluded) {
                mStatusBar.hideKeyguard();
