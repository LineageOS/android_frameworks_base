...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    public void reset(boolean hideBouncerWhenShowing, boolean isBackPressed) {
        if (mShowing) {
            if (mOccluded && !mDozing) {
                mStatusBar.hideKeyguard();
                if (hideBouncerWhenShowing || mBouncer.getFullscreenBouncer(false) ==
                        KeyguardBouncer.UNLOCK_SEQUENCE_DEFAULT) {
    ...
    public void setDozing(boolean dozing) {
        if (mDozing != dozing) {
            mDozing = dozing;
            if (dozing || mOccluded || mBouncer.getFullscreenBouncer(false) ==
                    KeyguardBouncer.UNLOCK_SEQUENCE_DEFAULT) {
    ...
    protected void updateStates() {
        ...
        boolean bouncerDismissible = mBouncer.getFullscreenBouncer(true) !=
