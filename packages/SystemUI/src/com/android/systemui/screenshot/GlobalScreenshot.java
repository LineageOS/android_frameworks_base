...
class GlobalScreenshot {
    ...
    private String mForegroundAppLabel;
            ...
            mUiOffloadThread.submit(() -> {
                try {
                    ...
                    if (focusedStack != null && focusedStack.topActivity != null) {
                        mForegroundAppLabel = mPm.getActivityInfo(focusedStack.topActivity, 0).applicationInfo
    ...
    private void saveScreenshotInWorkerThread(Consumer<Uri> finisher, String appLabel) {
        ...
        mSaveInBgTask = new SaveImageInBackgroundTask(mContext, data, mNotificationManager, appLabel)
                .execute();
    }
    ...
    private void takeScreenshot(Consumer<Uri> finisher, boolean statusBarVisible,
        ...
        startAnimation(finisher, mDisplayMetrics.widthPixels, mDisplayMetrics.heightPixels,
                statusBarVisible, navBarVisible, mForegroundAppLabel);
    }
