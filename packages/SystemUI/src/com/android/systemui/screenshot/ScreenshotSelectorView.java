 ...
 */
public class ScreenshotSelectorView extends RelativeLayout implements View.OnTouchListener {
    ...
    public ScreenshotSelectorView(Context context, @Nullable AttributeSet attrs) {
        ...
        mCircleRadius = (int) context.getResources()
                .getDimension(R.dimen.global_partial_screenshot_circle_radius);
        mBorderWidth = (int) context.getResources()
                .getDimension(R.dimen.global_partial_screenshot_line_width);
