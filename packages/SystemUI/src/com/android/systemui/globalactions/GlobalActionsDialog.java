...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    private ActionsDialog createDialog() {
        ...
        ActionsDialog dialog = new ActionsDialog(mContext, mAdapter, mOverflowAdapter,
                ...
                mSysUiState, this::onRotate, mKeyguardShowing, mPowerAdapter, mRestartAdapter, mUsersAdapter);
    ...
    final class UsersAction extends SinglePressAction {
        private UsersAction() {
            super(com.android.systemui.R.drawable.ic_lock_user, com.android.systemui.R.string.global_action_users);
        }
    ...
    protected void updatePowerMenuActions() {
        final String powerMenuActions = LineageSettings.Secure.getStringForUser(mContentResolver,
                LineageSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);

        if (powerMenuActions != null) {
            mActions = powerMenuActions.split("\\|");
        } else {
    ...
    static final class ActionsDialog extends Dialog implements DialogInterface,
        ...
        ActionsDialog(Context context, MyAdapter adapter, MyOverflowAdapter overflowAdapter,
                ...
                MyPowerOptionsAdapter powerAdapter, MyRestartOptionsAdapter restartAdapter, MyUsersAdapter usersAdapter) {
