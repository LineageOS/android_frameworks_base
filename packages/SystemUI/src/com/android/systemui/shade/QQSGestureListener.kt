...
import lineageos.providers.LineageSettings.System.DOUBLE_TAP_SLEEP_GESTURE
...
class QQSGestureListener @Inject constructor(
    ...
    init {
        val contentObserver = object : ContentObserver(null) {
            override fun onChange(selfChange: Boolean) {
                doubleTapToSleepEnabled = LineageSettings.System.getInt(
                        context.contentResolver, DOUBLE_TAP_SLEEP_GESTURE,
        ...
        context.contentResolver.registerContentObserver(
                LineageSettings.System.getUriFor(DOUBLE_TAP_SLEEP_GESTURE), false, contentObserver)
