...
public abstract class SecureSetting extends ContentObserver implements Listenable {
    ...
    public SecureSetting(Context context, Handler handler, String settingName, int userId, int defaultValue) {
        super(handler);
        mContext = context;
    ...
    public int getValue() {
        return Secure.getIntForUser(mContext.getContentResolver(), mSettingName, mDefaultValue, mUserId);
    }
