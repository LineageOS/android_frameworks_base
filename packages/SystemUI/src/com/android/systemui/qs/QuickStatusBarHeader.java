...
public class QuickStatusBarHeader extends RelativeLayout implements
    ...
    private boolean mIsQuickQsBrightnessEnabled = true;
    private boolean mIsQsAutoBrightnessEnabled = true;
    ...
    protected void onFinishInflate() {
        ...
        if (mIsQsAutoBrightnessEnabled && getResources().getBoolean(
    ...
    private void updateMinimumHeight() {
        ...
        int brtHeight = mContext.getResources()
                .getDimensionPixelSize(R.dimen.brightness_mirror_height)
                + mContext.getResources()
                .getDimensionPixelSize(R.dimen.qs_tile_margin_top);
