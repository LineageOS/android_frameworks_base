...
public class ProfilesTile extends QSTile<QSTile.State> implements KeyguardMonitor.Callback {
    ...
    private QSDetailItems mDetails;
    ...
    protected void handleUpdateState(State state, Object arg) {
        if (profilesEnabled()) {
            ...
            state.label = mContext.getString(R.string.quick_settings_profiles_label_off);
            state.contentDescription = mContext.getString(
    ...
    public class ProfileDetailAdapter implements DetailAdapter, AdapterView.OnItemClickListener {
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            mDetails = QSDetailItems.convertOrInflate(context, convertView, parent);
