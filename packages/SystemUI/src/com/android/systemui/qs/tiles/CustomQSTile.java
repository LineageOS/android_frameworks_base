...
public class CustomQSTile extends QSTile<QSTile.State> {
    ...
    private final CustomQSDetailAdapter mDetailAdapter;
    ...
    public Intent getLongClickIntent() {
        return mTile.getCustomTile().onLongClick.getIntent();
    }
    ...
    public CharSequence getTileLabel() {
        return mTile.getCustomTile().label;
    }
    ...
    private class CustomQSDetailAdapter implements DetailAdapter {
        ...
        public CharSequence getTitle() {
            return mContext.getString(R.string.quick_settings_custom_tile_detail_title);
        }
