...
public class FastChargeTile extends QSTileImpl<BooleanState> {
    ...
    private static final String CHANNEL_ID = "fastcharge";
    private static final int NOTIFICATION_ID = 273299;
    ...
    public FastChargeTile(QSHost host) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID,
                mContext.getString(R.string.quick_settings_fastcharge_label),
                NotificationManager.IMPORTANCE_DEFAULT);
        mNotificationManager.createNotificationChannel(notificationChannel);

        Notification.Builder builder = new Notification.Builder(mContext, CHANNEL_ID);
        builder.setContentTitle(
                mContext.getString(R.string.quick_settings_fastcharge_enabled_label));
        builder.setSmallIcon(R.drawable.ic_qs_fastcharge);
