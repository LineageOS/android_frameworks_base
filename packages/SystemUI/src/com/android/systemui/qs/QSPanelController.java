...
import static lineageos.providers.LineageSettings.Secure.QS_SHOW_AUTO_BRIGHTNESS;
import static lineageos.providers.LineageSettings.Secure.QS_SHOW_BRIGHTNESS_SLIDER;
...
public class QSPanelController extends QSPanelControllerBase<QSPanel> {
    ...
    protected void onViewAttached() {
        ...
        getContext().getContentResolver().registerContentObserver(
                LineageSettings.Secure.getUriFor(QS_SHOW_AUTO_BRIGHTNESS), false, mView.getContentObserver());
        mView.getContentObserver().onChange(true,
                LineageSettings.Secure.getUriFor(QS_SHOW_AUTO_BRIGHTNESS));
        getContext().getContentResolver().registerContentObserver(
                LineageSettings.Secure.getUriFor(QS_SHOW_BRIGHTNESS_SLIDER), false, mView.getContentObserver());
        mView.getContentObserver().onChange(true,
                LineageSettings.Secure.getUriFor(QS_SHOW_BRIGHTNESS_SLIDER));
        getContext().getContentResolver().registerContentObserver(
