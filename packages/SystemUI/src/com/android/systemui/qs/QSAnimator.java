...
public class QSAnimator implements Callback, PageListener, Listener, OnLayoutChangeListener,
    ...
    private static final String KEY_QUICK_QS_BRIGHTNESS =
            "lineagesystem:" + LineageSettings.System.QUICK_QS_BRIGHTNESS;
    ...
    public void onViewAttachedToWindow(View v) {
        ...
        Dependency.get(TunerService.class).addTunable(this, KEY_QUICK_QS_BRIGHTNESS);
    }
    ...
    public void onTuningChanged(String key, String newValue) {
        if (ALLOW_FANCY_ANIMATION.equals(key)) {
            ...
            clearAnimationState();
        } else if (KEY_QUICK_QS_BRIGHTNESS.equals(key)) {
