...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener, Dumpable {
    ...
    protected KeyguardUpdateMonitor(
        ...
        mContext.getContentResolver().registerContentObserver(
                ...
                LineageSettings.System.FINGERPRINT_WAKE_UNLOCK), false,
                mSettingsChangeObserver, UserHandle.USER_ALL);
    }

    private void updateFingerprintSettings() {
        // Get default value from overlay for existing users.
        ...
        mFingerprintWakeAndUnlock = LineageSettings.System.getIntForUser(
                ...
                def ? 1 : 0, UserHandle.USER_CURRENT) == 1;
        // Set default value user-toggle.
        LineageSettings.System.putIntForUser(mContext.getContentResolver(),
                LineageSettings.System.FINGERPRINT_WAKE_UNLOCK,
                mFingerprintWakeAndUnlock ? 1 : 0, UserHandle.USER_CURRENT);
    }
