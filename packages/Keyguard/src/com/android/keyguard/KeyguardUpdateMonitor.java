        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
                ...
                int newProvisionedState = intent.getIntExtra(EXTRA_NEW_PROVISION_STATE,
                        NOT_PROVISIONED);
                boolean provisioned = newProvisionedState == PROVISIONED;
                mProvisionStates.put(phoneId, provisioned ? State.UNKNOWN : State.NOT_READY);
            }
        }
    };
        ...
        if (state != null) {
            ...
            if (slotId != SubscriptionManager.INVALID_SIM_SLOT_INDEX) {
                try {
                    ...
                    boolean isProvisioned = provisioned == PROVISIONED;
