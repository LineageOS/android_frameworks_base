...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void toggleTorch() {
        final boolean origTorchState = mTorchEnabled;
        try {
        ...
        // Setup torch timeout only if it was turned on
        if (mTorchEnabled && !origTorchState && mTorchTimeout > 0) {
    ...
    private class TorchModeCallback extends CameraManager.TorchCallback {
        ...
        public void onTorchModeChanged(String cameraId, boolean enabled) {
            ...
            if (!mTorchEnabled && mTorchOffPendingIntent != null) {
                mAlarmManager.cancel(mTorchOffPendingIntent);
                mTorchOffPendingIntent = null;
            }
        }
