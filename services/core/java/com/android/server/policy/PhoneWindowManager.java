...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void updateKeyAssignments() {
        ...
        if (mHomeLongPressAction.ordinal() < Action.NOTHING.ordinal() ||
                mHomeLongPressAction.ordinal() > Action.SLEEP.ordinal()) {
        ...
        if (mHomeDoubleTapAction.ordinal() < Action.NOTHING.ordinal() ||
                mHomeDoubleTapAction.ordinal() > Action.SLEEP.ordinal()) {
