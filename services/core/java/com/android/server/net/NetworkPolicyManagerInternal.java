...
import static com.android.server.net.NetworkPolicyManagerService.isNetworkingRestrictedByUidRulesInternal;
...
public abstract class NetworkPolicyManagerInternal {
     ...
     */
    public static boolean isNetworkingRestrictedByUidRules(int uidRules) {
        return isNetworkingRestrictedByUidRulesInternal(uidRules);
    };
