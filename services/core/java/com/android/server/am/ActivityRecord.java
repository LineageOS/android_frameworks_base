...
final class ActivityRecord extends ConfigurationContainer implements AppWindowContainerListener {
    ...
    private final float mFullScreenAspectRatio = Float.parseFloat(Resources.getSystem().getString(
                    org.lineageos.platform.internal.R.string.config_screenAspectRatio));
    ...
    private void computeBounds(Rect outBounds) {
        outBounds.setEmpty();
        final float maxAspectRatio = (LineageSettings.System.getInt(service.mContext.getContentResolver(),
                LineageSettings.System.FULL_SCREEN_ASPECT_RATIO, 0) != 0)
