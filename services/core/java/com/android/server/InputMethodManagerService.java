    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void registerContentObserverLocked(@UserIdInt int userId) {
            ...
            if (mLineageHardware.isSupported(LineageHardwareManager.FEATURE_HIGH_TOUCH_SENSITIVITY)) {
                resolver.registerContentObserver(LineageSettings.System.getUriFor(
                        LineageSettings.System.HIGH_TOUCH_SENSITIVITY_ENABLE), false, this, userId);
            }
        ...
        @Override public void onChange(boolean selfChange, Uri uri) {
            ...
            final Uri touchSensitivityUri =
                    LineageSettings.System.getUriFor(LineageSettings.System.HIGH_TOUCH_SENSITIVITY_ENABLE);
            final Uri touchHoveringUri =
                    LineageSettings.Secure.getUriFor(LineageSettings.Secure.FEATURE_TOUCH_HOVERING);
