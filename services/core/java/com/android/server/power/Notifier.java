...
public class Notifier {
    ...
    /**
     * Called when wireless charging has been interrupted - to provide user feedback (sound and visual).
     */
    public void onWirelessChargingInterrupted(int batteryLevel, @UserIdInt int userId) {
        if (DEBUG) {
