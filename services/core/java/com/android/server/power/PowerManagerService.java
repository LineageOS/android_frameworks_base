...
public final class PowerManagerService extends SystemService
    ...
    private int mEvent;
    private boolean mButtonLightOnKeypressOnly = context.getResources().getBoolean(
            com.android.internal.R.bool.config_useButtonLightOnKeypressOnly);
                ...
                if (mLastUserActivityTime >= mLastWakeTime) {
                    ...
                    if (now < nextTimeout) {
                        ...
                        if (mWakefulness == WAKEFULNESS_AWAKE) {
                            ...
                            buttonPressed = mButtonLightOnKeypressOnly ? buttonPressed : true;
                            if (mButtonTimeout != 0
