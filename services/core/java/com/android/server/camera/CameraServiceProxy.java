...
public class CameraServiceProxy extends SystemService
    ...
    private final ICameraServiceProxy.Stub mCameraServiceProxy = new ICameraServiceProxy.Stub() {
        ...
        public void pingForUserUpdate() {
            if (Binder.getCallingUid() != Process.CAMERASERVER_UID
                    && (Binder.getCallingUid() != Process.MEDIA_UID || !mAllowMediaUid)) {
    ...
    public CameraServiceProxy(Context context) {
        ...
        mAllowMeidaUid = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_allowMediaUidForCameraProxy);
    }
