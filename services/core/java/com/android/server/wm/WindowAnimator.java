...
public class WindowAnimator {
    ...
    private boolean mBlurHideWallpaper;
    ...
    private void updateWindowsLocked(final int displayId) {
        ...
        if (mKeyguardGoingAway && !mBlurHideWallpaper) {
        ...
        for (int i = windows.size() - 1; i >= 0; i--) {
            ...
            if (winAnimator.hasSurface()) {
                ...
                if (mPolicy.getWinKeyguardPanelLw() == null && !winAnimator.mAnimating) {
                    shouldBeForceHidden &= !mBlurHideWallpaper;
                }
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe(Context context) {
            context.getContentResolver().registerContentObserver(
                    ...
                    false, this);
            context.getContentResolver().registerContentObserver(
                    CMSettings.Secure.getUriFor(CMSettings.Secure.LOCK_SCREEN_BLUR_HIDE_WALLPAPER),
                    false, this);
            onChange(true);
        }
        ...
        public void onChange(boolean selfChange) {
            boolean blurEnabled = CMSettings.Secure.getInt(mContext.getContentResolver(),
                    CMSettings.Secure.LOCK_SCREEN_BLUR_ENABLED, 0) == 1;
            boolean hideWallpaper = CMSettings.Secure.getInt(mContext.getContentResolver(),
                    CMSettings.Secure.LOCK_SCREEN_BLUR_HIDE_WALLPAPER, 0) == 1;
            mBlurHideWallpaper = blurEnabled && hideWallpaper;
        }
    }
}
