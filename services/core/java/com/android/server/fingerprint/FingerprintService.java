...
public class FingerprintService extends SystemService implements IHwBinder.DeathRecipient {
    ...
    private IFingerprintInscreen mFingerprintInscreen;
    ...
    public synchronized IFingerprintInscreen getFingerprintInScreenDaemon() {
        if (mFingerprintInscreen == null) {
            try {
                mFingerprintInscreen = IFingerprintInscreen.getService();
            } catch (NoSuchElementException | RemoteException e) {
                // do nothing
            }
        }
        return mFingerprintInscreen;
    }
