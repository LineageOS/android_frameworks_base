...
1import android.view.inputmethod.InputConnectionInspector.MissingMethodFlags;
...
public class InputMethodManagerService extends IInputMethodManager.Stub
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void registerContentObserverLocked(@UserIdInt int userId) {
            ...
            if (mLineageHardware.isSupported(
                ...
                resolver.registerContentObserver(LineageSettings.System.getUriFor(
                        LineageSettings.System.HIGH_TOUCH_SAMPLE_RATE_ENABLE),
                        false, this, userId);
            }
            if (mLineageHardware.isSupported(
        ...
        @Override public void onChange(boolean selfChange, Uri uri) {
            ...
            final Uri touchSensitivityUri = LineageSettings.System.getUriFor(
                    LineageSettings.System.HIGH_TOUCH_SENSITIVITY_ENABLE);
            final Uri touchSampleRateUri = LineageSettings.System.getUriFor(
                    LineageSettings.System.HIGH_TOUCH_SAMPLE_RATE_ENABLE);
            ...
            synchronized (mMethodMap) {
                ...
                } else if (touchSampleRateUri.equals(uri)) {
                    updateTouchSampleRate();
    ...
    private void updateTouchSampleRate() {
        if (!mLineageHardware.isSupported(LineageHardwareManager.FEATURE_HIGH_TOUCH_SAMPLE_RATE)) {
            return;
        }
        final boolean enabled = LineageSettings.System.getInt(mContext.getContentResolver(),
                LineageSettings.System.HIGH_TOUCH_SAMPLE_RATE_ENABLE, 0) == 1;
        mLineageHardware.set(LineageHardwareManager.FEATURE_HIGH_TOUCH_SAMPLE_RATE, enabled);
    }
