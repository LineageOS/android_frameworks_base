...
public final class BatteryService extends SystemService {
    ...
    private final class Led {
        ...
        public void updateLightsLocked() {
            ...
            final LineageBatteryLights lbl = mLineageBatteryLights;

            final int level = mBatteryProps.batteryLevel;
            final int status = mBatteryProps.batteryStatus;
            final int brightnessLevel = lbl.calcBrightness(level);

            if (!lbl.mLightEnabled) {
                ...
                if (status == BatteryManager.BATTERY_STATUS_CHARGING) {
                    ...
                    mBatteryLight.setColor(lbl.mBatteryLowARGB);
                } else if (lbl.mLedPulseEnabled) {
                    // Battery is low and not charging
                    mBatteryLight.setFlashing(lbl.mBatteryLowARGB, Light.LIGHT_FLASH_TIMED,
                ...
                if (status == BatteryManager.BATTERY_STATUS_FULL || level >= 90) {
                    ...
                    mBatteryLight.setColor(lbl.mBatteryFullARGB);
                } else {
                    // Battery is charging and halfway full
                    mBatteryLight.setColor(lbl.mBatteryMediumARGB);
                }
            } else {
