...
public final class BatteryService extends SystemService {
    ...
    private boolean mOemFastChargerStatusPath;
    ...
    public BatteryService(Context context) {
        ...
        mOemFastChargerStatusPath = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_oemFastChargerStatusPath);
    ...
    private void sendIntentLocked() {
        ...
        intent.putExtra(BatteryManager.EXTRA_OEM_FAST_CHARGER, mBatteryProps.oemFastChargeStatus);
        if (DEBUG) {
